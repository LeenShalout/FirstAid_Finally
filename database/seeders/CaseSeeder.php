    ...
    public function run() {
        ...
        $data = [
            ...
            [
                ...
                'Photo'=>'FloodsCase.jpeg',
                'Video'=>'https://www.youtube.com/embed/dvuGyLZh-og?si=_UaYklLHjopECg98',
            ],
            [
                'MainPhoto' => 'Wildfires.jpeg',
                'Description' =>'Wildfires are uncontrolled fires that spread rapidly through wildland areas, often fueled by dry vegetation, high winds, and hot temperatures.',
                'Category' => 'Natural_Disasters',
                'Title' => 'Wildfires',
                'Intro' =>"Wildfires are uncontrolled fires that spread rapidly through wildland areas, such as forests, grasslands, and brushlands. They can destroy homes, wildlife habitats, and natural resources, and pose serious risks to human life. Knowing what to do before, during, and after a wildfire can help keep you and your loved ones safe.",
                'Before'=>"Clear flammable vegetation at least 30 feet away from your home to create a defensible space. Trim trees and shrubs, and remove dead leaves and branches. / Assemble an emergency kit with essential supplies such as water, non-perishable food, a first aid kit, flashlight, batteries, and important documents. /Develop a family emergency plan that includes evacuation routes, meeting points, and communication methods. /Monitor weather forecasts and wildfire alerts from local authorities.",
                'During'=>"If you are advised to evacuate, do so immediately. Follow designated evacuation routes and do not attempt to return home until it is safe to do so. /Listen to the radio or check official sources for updates and instructions from local authorities. /Stay indoors and keep windows and doors closed to prevent smoke from entering your home. Use air purifiers or HEPA filters to improve indoor air quality. /If you are trapped outdoors, move to a cleared area such as a road or parking lot, and lie flat on the ground, covering your body with clothing or a blanket.",
                'After'=>"Wait for authorities to declare it safe before returning home. Be cautious when entering a burned area, as hazards such as hot spots, unstable ground, and falling debris may still be present. /Inspect your home for damage before entering. Look for signs of structural damage, gas leaks, electrical damage, and ash or embers that may still be smoldering. /Take photos of any damage to your property and belongings for insurance purposes. /Wear protective clothing such as gloves and a mask when cleaning up ash and debris. Dispose of ash and debris properly, following guidelines from local authorities.",
                'Prevention_Tips'=>"Clear flammable vegetation and debris from around your home to create a defensible space. /Use fire-resistant building materials and landscaping techniques to make your home more resistant to wildfires. /Follow local fire restrictions and regulations, and avoid activities that could spark a wildfire, such as outdoor burning or using fireworks.",
                'Photo'=>'WildfiresCase.jpeg',
                'Video'=>'https://www.youtube.com/embed/YsOL-kgc9UU?si=SH6CuJ6JC7_CjKmo',
            ],
           /* [
                'MainPhoto' => '',
                'Description' =>'',
